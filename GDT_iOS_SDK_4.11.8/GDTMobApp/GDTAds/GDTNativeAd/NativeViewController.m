...
@property (strong, nonatomic) UITextView *responseTextView;
...
- (IBAction)loadAd:(id)sender {
     ...
     * 这里详情图以1280*720为例
     */
    self.responseTextView = [[UITextView alloc] initWithFrame:CGRectMake(30, CGRectGetMaxY(self.posTextField.frame) + 10, self.view.frame.size.width - 60, self.view.frame.size.height - CGRectGetMaxY(self.posTextField.frame) - 10 - 50)];
...
- (IBAction)attach:(id)sender {
    if (self.adArray.count > 0 && !_attached) {
        ...
        imgV.accessibilityIdentifier = @"native_big_image";
        ...
        iconV.accessibilityIdentifier = @"native_small_image";
        ...
        txt.accessibilityIdentifier = @"native_txt";
        ...
        desc.accessibilityIdentifier = @"native_desc";
...
-(void)nativeAdSuccessToLoad:(NSArray *)nativeAdDataArray
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        for (GDTNativeAdData *data in nativeAdDataArray) {
            ...
            NSLog(@"eCPM:%ld eCPMLevel:%@", [data eCPM], [data eCPMLevel]);
        }
...
- (UIView *)adView
{
    if (!_adView) {
        ...
        _adView.accessibilityIdentifier = @"native_ad";
